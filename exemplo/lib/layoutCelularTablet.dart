...
class LayoutCelularTablet extends StatefulWidget {
  const LayoutCelularTablet({Key? key}) : super(key: key);

  @override
  State<LayoutCelularTablet> createState() => _LayoutCelularTabletState();
}

class _LayoutCelularTabletState extends State<LayoutCelularTablet> {
  @override
