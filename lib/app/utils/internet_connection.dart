...
class InternetConnection {
  ...
  static Future<bool> validInternet(String errorMessage, RxBool loadingAnimetion, LoadingWithSuccessOrErrorTabletPhoneWidget loadingWithSuccessOrErrorTabletPhoneWidget) async {
    try {
