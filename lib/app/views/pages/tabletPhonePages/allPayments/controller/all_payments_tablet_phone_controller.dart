...
class AllPaymentsTabletPhoneController extends GetxController {
  late RxBool statusOpen;
  late RxBool statusClose;
  late RxBool statusLate;
  late List<TagFilterTabletPhoneWidget> tagsFilterList;
  late List<CardPaymentViewController> cardPaymentList;

  AllPaymentsTabletPhoneController(){
  ...
  _initializeLists(){
    tagsFilterList = <TagFilterTabletPhoneWidget> [
      TagFilterTabletPhoneWidget(
