...
class AcademicTabViewAfterLoadingTabletPhoneWidget extends StatefulWidget {
  late final MainMenuTabletPhoneController controller;
  AcademicTabViewAfterLoadingTabletPhoneWidget({
    Key? key,
    required this.controller,
  }) : super(key: key);

  @override
  State<AcademicTabViewAfterLoadingTabletPhoneWidget> createState() => _AcademicTabViewAfterLoadingTabletPhoneWidgetState();
}

class _AcademicTabViewAfterLoadingTabletPhoneWidgetState extends State<AcademicTabViewAfterLoadingTabletPhoneWidget> with SingleTickerProviderStateMixin {
  @override
  void initState() {
