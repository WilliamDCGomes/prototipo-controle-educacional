...
class FinancialTabViewTabletPhoneWidget extends StatefulWidget {
  late final MainMenuTabletPhoneController controller;
  FinancialTabViewTabletPhoneWidget({
    Key? key,
    required this.controller,
  }) : super(key: key);

  @override
  State<FinancialTabViewTabletPhoneWidget> createState() => _FinancialTabViewTabletPhoneWidgetState();
}

class _FinancialTabViewTabletPhoneWidgetState extends State<FinancialTabViewTabletPhoneWidget> with SingleTickerProviderStateMixin {
  @override
  void initState() {
