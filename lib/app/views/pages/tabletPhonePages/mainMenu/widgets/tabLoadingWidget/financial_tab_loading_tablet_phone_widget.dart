...
class FinancialTabLoadingTabletPhoneWidget extends StatefulWidget {
  late final MainMenuTabletPhoneController controller;
  FinancialTabLoadingTabletPhoneWidget({
    Key? key,
    required this.controller,
  }) : super(key: key);

  @override
  State<FinancialTabLoadingTabletPhoneWidget> createState() => _FinancialTabLoadingTabletPhoneWidgetState();
}

class _FinancialTabLoadingTabletPhoneWidgetState extends State<FinancialTabLoadingTabletPhoneWidget> with SingleTickerProviderStateMixin {
  @override
