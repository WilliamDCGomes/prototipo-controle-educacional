...
class SelectCardPaymentWidget extends StatefulWidget {
  const SelectCardPaymentWidget({Key? key}) : super(key: key);

  @override
  State<SelectCardPaymentWidget> createState() => _SelectCardPaymentWidgetState();
}

class _SelectCardPaymentWidgetState extends State<SelectCardPaymentWidget> with TickerProviderStateMixin {
  late StudentRequestController studentRequestController;

  @override
  void initState() {
    studentRequestController = Get.find(tag: "student-request-controller");
    studentRequestController.animationController = AnimationController(vsync: this);
    studentRequestController.animationController.duration = Duration(seconds: 2);
    super.initState();
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                Obx(
                  () => Visibility(
                    visible: studentRequestController.animationSuccess.value,
                    child: Container(
                      height: 100.h,
                      width: 100.w,
                      ...
                      child: Center(
                        child: Lottie.asset(
                          ...
                          width: 20.h,
                          fit: BoxFit.fill,
                          controller: studentRequestController.animationController
                        ),
                      ),
                    ),
                  ),
