...
class BottomSelectPaymentFormTabletPhoneWidget extends StatefulWidget {
  late final String cardTitle;
  late final RxBool cardSelected;

  BottomSelectPaymentFormTabletPhoneWidget({
    Key? key,
  ...
  @override
  State<BottomSelectPaymentFormTabletPhoneWidget> createState() => _BottomSelectPaymentFormTabletPhoneWidgetState();
}

class _BottomSelectPaymentFormTabletPhoneWidgetState extends State<BottomSelectPaymentFormTabletPhoneWidget> {
  @override
